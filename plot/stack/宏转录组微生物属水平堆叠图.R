...
data <- read.csv("./data/temp/宏转录组属水平top10相对丰度.csv", header = TRUE, row.names = 1, encoding = "UTF-8", check.names = FALSE)
...
g + p
ggsave(filename = "./pdf/transcriptome stack genus.pdf", g + p, width = 35, height = 20, dpi = 600, units = "cm", device = 'pdf')
